              ...
              <div className="container">
                <div className="slide">
                  <div className="caption">
                    ...
                    <a href="_" className="discover">
                      Discover Now
                    </a>
                  </div>
                  <img
                    src="https://cdn.shopify.com/s/files/1/0606/6867/4281/files/1_2700x.jpg?v=1635845602"
                    alt="slide"
                  />
                </div>
              </div>
            ...
            <SwiperSlide>
              <div className="container">
                <div className="slide">
                  ...
                  <img
                    src="https://cdn.shopify.com/s/files/1/0606/6867/4281/files/3_2700x.jpg?v=1635846056"
                    alt="slide"
                  />
                </div>
              </div>
            ...
            <SwiperSlide>
              <div className="container">
                <div className="slide">
                  ...
                  <img
                    src="https://cdn.shopify.com/s/files/1/0606/6867/4281/files/2_1512x.jpg?v=1635845964"
                    alt="slide"
                  />
                </div>
              </div>
