                ...
                <SwiperSlide key={index}>
                    <div className="productItem" >
                        ...
                        <div className="asideActions">
                            <div className='seeProduct' onClick={() => navigate(`/viewproduct/${item.id}`)} ><i className="fa-regular fa-eye"></i></div>
                            <div className='compareProduct'><i className="fa-solid fa-layer-group"></i></div>
                            <div className='loveProduct' style={item.wish ? { backgroundColor: '#fdc801' } : { backgroundColor: '#f5f5f5' }} onClick={() => addWishHandle(item)}><i className="fa-regular fa-heart"></i></div>
                        </div>
                        ...
                        <div className="productCollections">
                            ...
                            <div className="statusBar"> <div style={{ width: '85%' }} className="soldBar"> &nbsp;</div></div>
                        ...
                        <div className="productOverlay">
                            <span className='addToCart' onClick={() => addToCart(item)}>Add to cart</span>
                        </div>
                    </div>
                </SwiperSlide>
            )}
