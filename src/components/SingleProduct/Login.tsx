...
const Login: React.FC = () => {
    ...
    const onChange = (key: string) => {  // Tabs
        // console.log(key); 
    };
    ...
    return (
        <>
            <Drawer className='loginDrawer' closable={false} placement="top" onClose={onClose} open={open}>
                <Tabs
                    defaultActiveKey="1"
                    onChange={onChange}
                    items={[
                            ...
                            children: (
                                <>
                                    ...
                                    >
                                        ...
                                        <Form.Item valuePropName="checked" wrapperCol={{ offset: 0, span: 16 }}>
                                            <Checkbox>Remember me</Checkbox>
                                        </Form.Item>

                                        <Form.Item wrapperCol={{ offset: 0, span: 24 }} >
                                            <Button className='loginBtn' type='ghost' htmlType="submit" block={true} color='warning'>
                                                Login
                                            </Button>
                                        </Form.Item>
                                    </Form>
                            ...
                            children: (
                                <>
                                    ...
                                    >
                                        ...
                                        <Form.Item wrapperCol={{ offset: 0, span: 24 }}>
                                            <Button className='registrationBtn' htmlType="submit" block={true} >
                                                Registration
                                            </Button>
                                        </Form.Item>
                                    </Form>
