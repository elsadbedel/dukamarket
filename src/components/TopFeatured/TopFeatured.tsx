...
const TopFeatured: React.FC = () => {
  ...
  const fourFeaturedProducts = useAppSelector(state =>
    state.users.products.slice(0, 4)
  );
  const dispatch = useAppDispatch();
  const addWishHandle = () => {
    !topFeaturedProduct.wish
      ? dispatch(addWish(topFeaturedProduct))
      : dispatch(deleteWish(topFeaturedProduct));
                  ...
                  <div className="topFeaturedLeftContent">
                    ...
                    <div className="money">
                      <span className="current">
                        ${topFeaturedProduct.price}
                      </span>
                      <span className="compare">
                        ${topFeaturedProduct.discountedPrice}
                      </span>
                    </div>
                    ...
                    <div className="btnProducts">
                      <span
                        ...
                        onClick={() => {
                          ...
                          dispatch(addCart(topFeaturedProduct));
                        }}
                      >
                        Add to cart
                      </span>
                      <span
                        className="btnAddToWishList"
                        style={
                          topFeaturedProduct.wish
