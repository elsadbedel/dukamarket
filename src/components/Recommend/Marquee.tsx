...
const Marquee: React.FC = () => {
    return (
        <section id="marquee">
            <MarqueeC direction="left" speed={60} pauseOnHover={true} className="myMarquee" gradient={false}>
                ...
                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; With each receipt over $150 from AYO Store get voucher <strong>15% off</strong> immediately.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
            </MarqueeC>
        </section>
    )
}
